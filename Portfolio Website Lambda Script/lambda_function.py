...
def email_response(name, critical_phrase_list, list_of_extracted_phrases, AWS_Comprehend_Sentiment_Dump):
    ...
    Farewell_Text = f'Thank you for your email. If there is anything else I can assist \
...
def lambda_handler(event, context):
    ...
    t = ['medium', 'article', 'Medium', 'Article']
    ...
    # --- Insert your code here ---
    # Do not change the name of this variable
    email_text = email_response(dec_dict['name'], t, key_phrases, sentiment)
